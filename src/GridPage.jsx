...
const GridPage = () => {
  return (
    <>
      ...
      <div className="flex justify-between  bg-cover bg-[url('./assets/wood.png')]  shadow-lg border-2 border-yellow-600">
        <BettingSection />
        <Statistics />
        <AndarBaharButtons />
      </div>
...
const Header = () => {
  return (
    <div className="flex justify-between items-center py-5 px-10 bg-cover bg-[url('./assets/wood.png')] relative font-questrial">
